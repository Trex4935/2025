...
public class cm_ColorToggle extends Command {
  ...
  public cm_ColorToggle(LEDSubsystem leds, boolean toggleUp) {
    m_LEDs = leds;
    toggle = toggleUp;
  ...
  public void execute() {
    ...
    if (toggle) {
      Constants.ledConstant++;
    } else {
      Constants.ledConstant--;
    }
    m_LEDs.cm_setLedToColor(colors[Constants.ledConstant]).schedule();
  }
