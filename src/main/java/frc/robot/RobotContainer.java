...
public class RobotContainer {
 ...
 // Vision m_vision = new Vision();
  ...
  private void configureBindings() {
    ...
    operator.a().whileTrue(m_intake.cm_intakeCoral(0.25));
    operator.b().whileTrue(m_intake.cm_intakeCoral(-0.1));
    ...
    operator.b().whileTrue(m_elevator.cm_setElevatorState("L2"));
